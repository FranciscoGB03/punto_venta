...
import { guardaPresentacion } from '../../../api/productoApi';
    ...
    return (
        <div className="card border-tabla z-depth-2">
            ...
            <div className="m-2">
                ...
                <Campo etiqueta={`${i18next.t('catalogos:codigo')}: `}
                       data="codigo"
                       containerClass="d-flex justify-content-start mt-1"
                       inputClass={`form-control form-control-sm ml-1 ${!registro.codigo ? 'is-invalid' : ''}`}
