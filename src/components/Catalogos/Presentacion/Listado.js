    ...
    return (
        ...
        <tr>
            ...
            <th className='text-center cursor'
                ...
                <IconosSort key_sort={'codigo'} key_actual={sort.key} order={sort.order}/>
                {i18next.t('catalogos:codigo')}
            </th>
            <th className='text-center cursor'
...
const TheadBuscador = ({filtro, setFiltro}) => {
    return (
        ...
        <tr>
            ...
            <th className='py-1'>
                <input className='form-control form-control-sm' value={filtro.codigo || ""}
                       placeholder={i18next.t('catalogos:buscar')}
