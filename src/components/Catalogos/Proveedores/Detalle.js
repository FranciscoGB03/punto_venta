...
import { guardaProveedor } from '../../../api/proveedoresApi';
    ...
    return (
        <div className="card border-tabla z-depth-2">
            ...
            <div className="m-2">
                ...
                <Campo etiqueta={`${i18next.t('catalogos:rfc')}: `}
                       data="rfc"
                       containerClass="d-flex justify-content-start mt-1"
                       inputClass={`form-control form-control-sm ml-1 ${!registro.rfc ? 'is-invalid' : ''}`}
                       value={registro.rfc || ''}
                       autoFocus={true}
                       maxLength={13}
                       onChange={e => setRegistro({...registro, rfc: e.target.value})}/>
                <Campo etiqueta={`${i18next.t('catalogos:razonSocial')}: `}
                       data="razonsocial"
                       labelClass="text-nowrap"
                       containerClass="d-flex justify-content-start mt-1"
                       inputClass={`form-control form-control-sm ml-1 ${!registro.razonsocial ? 'is-invalid' : ''}`}
                       value={registro.razonsocial || ''}
                       autoFocus={true}                       
                       onChange={e => setRegistro({...registro, razonsocial: e.target.value})}/>
                <Campo etiqueta={`${i18next.t('catalogos:contacto')}: `}
                       data="contacto"
                       containerClass="d-flex justify-content-start mt-1"
                       inputClass={`form-control form-control-sm ml-1 ${!registro.contacto ? 'is-invalid' : ''}`}
                       value={registro.contacto || ''}
                       autoFocus={true}                       
                       onChange={e => setRegistro({...registro, contacto: e.target.value})}/>
                <Campo etiqueta={`${i18next.t('catalogos:email')}: `}
                       data="emailcontacto"
                       labelClass="text-nowrap"
                       containerClass="d-flex justify-content-start mt-1"
                       inputClass={`form-control form-control-sm ml-1 ${!registro.emailcontacto ? 'is-invalid' : ''}`}
                       value={registro.emailcontacto || ''}
                       autoFocus={true}                       
                       type="email"
                       onChange={e => setRegistro({...registro, emailcontacto: e.target.value})}/>
                <Campo etiqueta={`${i18next.t('catalogos:telefono')}: `}
                       data="telefonocontacto"
                       labelClass="text-nowrap"
                       containerClass="d-flex justify-content-start mt-1"
                       inputClass={`form-control form-control-sm ml-1 ${!registro.telefonocontacto ? 'is-invalid' : ''}`}
                       value={registro.telefonocontacto || ''}
                       autoFocus={true}                       
                       type="number"
                       onChange={e => setRegistro({...registro, telefonocontacto: e.target.value})}/>
